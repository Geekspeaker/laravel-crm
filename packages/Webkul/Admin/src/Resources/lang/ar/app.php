...
return [
        ...
        'users' => [
            'index' => [
                ...
                'create' => [
                    ...
                    'select-at-lest-one-group' => 'اختر مجموعة واحدة على الأقل',
                ],
                'edit' => [
        ...
        'index' => [
            ...
            'general' => [
                ...
                'settings' => [
                    ...
                    'menu-color' => [
                        ...
                        'title' => 'إعدادات ألوان عناصر القائمة',
                    ],
                ],
            ],
            'email' => [
            ...
            'magic-ai' => [
                ...
                'settings' => [
                    ...
                    'api-domain-info' => 'Base URL for the AI API. Default is the OpenAI native API (https://api.openai.com/v1).',
                    'enable' => 'تمكين',
                    ...
                    'models' => [
                        ...
                        'nvidia-llama-3-1-405b' => 'Llama 3.1 405B (NVIDIA)',
                        'nvidia-nemotron-70b' => 'Nemotron 70B (NVIDIA)',
                        'nvidia-deepseek-r1' => 'DeepSeek-R1 (NVIDIA)',
                        'title' => 'النماذج',
                    ],
                ],
            ],
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'كل ما تحتاجه لتحقيق أقصى استفادة من لوحة تحكم Krayin — الاستضافة والدعم والخدمات الاحترافية، بالإضافة إلى الإضافات ووثائق المطوّرين.',
            'contact-us' => 'اتصل بنا',
            'view-all' => 'عرض الكل',
            'still-need-help-title' => 'هل ما زلت بحاجة إلى مساعدة؟',
            'still-need-help-description' => 'تحدّث مع فريق Krayin حول الاستضافة أو التطوير المخصص أو أي شيء آخر.',

            'services' => [
                'title' => 'الخدمات والموارد',
                'cloud-hosting' => [
                    'title' => 'الاستضافة السحابية',
                    'description' => 'استضافة سحابية مُدارة وفعّالة من حيث التكلفة — جرّب وأطلق Krayin على السحابة في دقائق، مُحسّنة بالكامل وقابلة للتوسّع.',
                ],
                'support' => [
                    'title' => 'الدعم والصيانة',
                    'description' => 'دعم فني مخصّص وخطط صيانة مستمرة للحفاظ على نظام CRM آمنًا ومُحدّثًا ويعمل بسلاسة.',
                ],
                'extensions' => [
                    'title' => 'الإضافات',
                    'description' => 'تصفّح الإضافات الرسمية وإضافات المجتمع لتوسيع Krayin بموصّلات وقنوات وميزات جديدة.',
                ],
            ],
            ...
            'resources' => [
                ...
                'user-docs' => [
                    'title' => 'دليل المستخدم',
                    'description' => 'مساعدة احترافية لدمج الوحدات والتخصيص وترحيل البيانات وترقيات الإصدارات والتطوير المخصص.',
                ],
                'dev-docs' => [
                    'title' => 'وثائق المطوّرين والمدوّنات',
                    'description' => 'أدلة المطوّرين والدروس التعليمية وأحدث المقالات لمساعدتك على البناء والتهيئة والبقاء على اطلاع دائم.',
                ],
                'api-docs' => [
                    'title' => 'وثائق API',
                    'description' => 'مرجع كامل لواجهة REST API مع نقاط النهاية والمصادقة وأمثلة لدمج Krayin مع نظامك.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'تواصل مع آلاف المستخدمين والمطوّرين الآخرين في Krayin لتبادل النصائح وحل المشكلات.',
                    'link' => 'انضم إلى المجتمع',
                ],
                'tutorials' => [
                    'title' => 'دروس فيديو تعليمية',
                    'description' => 'شاهد أدلة فيديو خطوة بخطوة حول إعداد نظام CRM وتهيئة قنوات البيع وإدارة المستخدمين.',
                    'link' => 'تصفّح قناة YouTube',
                ],
            ],
        ],
    ],
