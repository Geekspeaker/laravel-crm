        ...
        'index' => [
            ...
            'magic-ai' => [
                ...
                'settings' => [
                    ...
                    'api-domain-info' => 'Base URL for the AI API. Default is the OpenAI native API (https://api.openai.com/v1). Change it to use Azure OpenAI, a self-hosted OpenAI-compatible gateway, or OpenRouter.',
                    'enable' => 'Enable',
