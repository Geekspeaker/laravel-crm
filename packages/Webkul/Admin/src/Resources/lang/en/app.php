    ...
    'configuration' => [
        'index' => [
            ...
            'magic-ai' => [
                ...
                'settings' => [
                    'api-key' => 'API Key',
                    'api-key-info' => 'Use your OpenAI API key (sk-...). It is used to authenticate requests to the OpenAI API.',
                    'api-domain' => 'API Domain',
                    'api-domain-info' => 'Base URL for the AI API. Default is the OpenAI native API (https://api.openai.com/v1). Change it to use NVIDIA NIM (https://integrate.api.nvidia.com/v1), Azure OpenAI, a self-hosted OpenAI-compatible gateway, or OpenRouter.',
                    'enable' => 'Enable',
                    'info' => 'Enhance your Magic AI experience with your OpenAI API Key. Integrate it now for a seamless, personalized AI adventure tailored just for you! Effortlessly customize settings and take control of your AI journey.',
                    'other' => 'Other Model',
                    'other-model' => 'For other models, enter the OpenAI model ID (e.g. o3, o4-mini, chatgpt-4o-latest).',
